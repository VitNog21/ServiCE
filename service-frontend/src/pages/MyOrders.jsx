    ...
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div className="flex space-x-4 mb-6 border-b border-gray-200">
        <button 
          ...
          className={`pb-4 px-2 font-medium transition-colors ${tab === 'compras' ? 'border-b-2 border-[#0A847C] text-[#0A847C]' : 'text-gray-500 hover:text-gray-700'}`}
        >
        ...
        <button 
          ...
          className={`pb-4 px-2 font-medium transition-colors ${tab === 'vendas' ? 'border-b-2 border-[#0A847C] text-[#0A847C]' : 'text-gray-500 hover:text-gray-700'}`}
        >
          <div className="flex items-center">
